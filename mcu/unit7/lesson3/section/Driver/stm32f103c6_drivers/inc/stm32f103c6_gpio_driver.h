...
//@ref GPIO_PIN_define.
#define GPIO_PIN_0                (uint16_t) 0x0001//01
#define GPIO_PIN_1                (uint16_t) 0x0002//10
#define GPIO_PIN_2                (uint16_t) 0x0004//100
#define GPIO_PIN_3                (uint16_t) 0x0008//1000
#define GPIO_PIN_4                (uint16_t) 0x0010//10000
...
#define GPIO_MASK_PIN             (uint16_t) 0x0000ffff
...
void MCAL_GPIO_TOGGLE_PIN(GPIO_typedef *GPIOX,uint8_t pinNumber);
